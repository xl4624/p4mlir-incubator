...
// CHECK:           %[[VAL_6:.*]] = p4hir.read %[[VAL_1]] : <!H1_>
// CHECK:           p4hir.assign %[[VAL_6]], %[[VAL_5]] : <!H1_>
// CHECK:           %[[VAL_7:.*]] = p4hir.const #[[$ATTR_4]]
// CHECK:           %[[VAL_8:.*]] = p4hir.const #[[$ATTR_6]]
// CHECK:           %[[VAL_9:.*]] = p4hir.struct (%[[VAL_7]], %[[VAL_8]]) : !H2_
// CHECK:           %[[VAL_10:.*]] = p4hir.variable ["h2", init] : <!H2_>
// CHECK:           p4hir.assign %[[VAL_9]], %[[VAL_10]] : <!H2_>
// CHECK:           %[[VAL_11:.*]] = p4hir.struct_extract_ref %[[VAL_0]]["h2"] : <!U>
// CHECK:           %[[VAL_12:.*]] = p4hir.read %[[VAL_10]] : <!H2_>
// CHECK:           p4hir.assign %[[VAL_12]], %[[VAL_11]] : <!H2_>
...
// CHECK:           %[[VAL_5:.*]] = p4hir.read %[[VAL_1]] : <!H1_>
// CHECK:           p4hir.assign %[[VAL_5]], %[[VAL_4]] : <!H1_>
...
// CHECK:           %[[VAL_6:.*]] = p4hir.read %[[VAL_1]] : <!H1_>
// CHECK:           p4hir.assign %[[VAL_6]], %[[VAL_5]] : <!H1_>
// CHECK:           %[[VAL_7:.*]] = p4hir.variable ["h2"] : <!H1_>
// CHECK:           %[[VAL_8:.*]] = p4hir.read %[[VAL_0]] : <!U>
// CHECK:           %[[VAL_9:.*]] = p4hir.struct_extract %[[VAL_8]]["h1"] : !U
// CHECK:           p4hir.assign %[[VAL_9]], %[[VAL_7]] : <!H1_>
