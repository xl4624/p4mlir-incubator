...
// CHECK:           %[[VAL_11:.*]] = p4hir.shl(%[[VAL_9]], %[[VAL_10]] : !b8i) : !b32i
...
// CHECK:           %[[VAL_15:.*]] = p4hir.shl(%[[VAL_14]], %[[VAL_13]] : !infint) : !b32i
...
// CHECK:           %[[VAL_19:.*]] = p4hir.shl(%[[VAL_17]], %[[VAL_18]] : !b8i) : !i32i
...
// CHECK:           %[[VAL_23:.*]] = p4hir.shl(%[[VAL_22]], %[[VAL_21]] : !infint) : !i32i
...
// CHECK:           %[[VAL_28:.*]] = p4hir.shr(%[[VAL_26]], %[[VAL_27]] : !b8i) : !b32i
...
// CHECK:           %[[VAL_32:.*]] = p4hir.shr(%[[VAL_31]], %[[VAL_30]] : !infint) : !b32i
...
// CHECK:           %[[VAL_36:.*]] = p4hir.shr(%[[VAL_34]], %[[VAL_35]] : !b8i) : !i32i
...
// CHECK:           %[[VAL_40:.*]] = p4hir.shr(%[[VAL_39]], %[[VAL_38]] : !infint) : !i32i
